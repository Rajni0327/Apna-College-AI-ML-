...
# lamada functions -> anonymous functions -> functions without a name
# higher order functions -> functions that can take other functions as arguments or return a function as a result
